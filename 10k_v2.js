// List borrowed from https://github.com/first20hours/google-10000-english

Constants.limit = 8000;
...
'mediawiki',
'configurations',
'poison'].slice(0, Constants.limit).map(function(x) { return x.toUpperCase(); });
Constants.tenkWords = Constants.tenk.map(function(w) { return new Word(w); });
